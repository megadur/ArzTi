...
using ArzTiServer.Authentication;
using ArzTiServer.Filters;
using ArzTiServer.OpenApi;
using ArzTiServer.Formatters;
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwagger(c =>
                ...
                .UseSwaggerUI(c =>
                {
                    ...
                    c.SwaggerEndpoint("/openapi/V1/openapi.json", "Webservice ArzTI API");

                    //TODO: Or alternatively use the original OpenAPI contract that's included in the static files
                    // c.SwaggerEndpoint("/openapi-original.json", "Webservice ArzTI API Original");
                });
            app.UseRouting();

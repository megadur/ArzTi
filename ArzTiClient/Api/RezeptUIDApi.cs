...
namespace IO.Swagger.Api
{
        ...
        public interface IRezeptUIDApi : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<ApiResponse<Rezept>> DeleteRezeptUIdAsyncWithHttpInfo (string ruid);
        /// <summary>
        /// liefert ein Rezept
        /// </summary>
        /// <remarks>
        ...
        /// <param name="ruid">Die Rezept UID.</param>
        /// <returns>Task of ApiResponse (Rezept)</returns>
        System.Threading.Tasks.Task<ApiResponse<Rezept>> GetRezeptUIdAsyncWithHttpInfo (string ruid);
        /// <summary>
        /// liefert den Status eines Rezepts
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<ApiResponse<RezeptStatus>> GetRezeptUIdStatusAsyncWithHttpInfo (string ruid);
        /// <summary>
        /// Statusänderung eines Rezeptes
        /// </summary>
        /// <remarks>
        ...
        /// <param name="status">Status value</param>
        /// <returns>Task of ApiResponse (RezeptStatus)</returns>
        System.Threading.Tasks.Task<ApiResponse<RezeptStatus>> PatchRezeptUIdStatusAsyncWithHttpInfo (string ruid, string status);
        ...
        public partial class RezeptUIDApi : IRezeptUIDApi
    {
        ...
        /// <returns></returns>
        public RezeptUIDApi(IO.Swagger.Client.Configuration configuration = null)
        {
        ...
        /// <summary>
        /// löscht ein Rezept deleteRezeptUId
        /// </summary>
        /// <exception cref="IO.Swagger.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="ruid">Die Rezept UID.</param>
        /// <returns>Rezept</returns>
        ...
        /// <param name="ruid">Die Rezept UID.</param>
        /// <returns>Task of Rezept</returns>
        public async System.Threading.Tasks.Task<Rezept> DeleteRezeptUIdAsync (string ruid)
        {
             ApiResponse<Rezept> localVarResponse = await DeleteRezeptUIdAsyncWithHttpInfo(ruid);
             return localVarResponse.Data;
        ...
        /// <param name="ruid">Die Rezept UID.</param>
        /// <returns>Task of ApiResponse (Rezept)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Rezept>> DeleteRezeptUIdAsyncWithHttpInfo (string ruid)
        {
            // verify the required parameter 'ruid' is set
            if (ruid == null)
                throw new ApiException(400, "Missing required parameter 'ruid' when calling RezeptUIDApi->DeleteRezeptUId");
        ...
        /// <param name="ruid">Die Rezept UID.</param>
        /// <returns>Task of Rezept</returns>
        public async System.Threading.Tasks.Task<Rezept> GetRezeptUIdAsync (string ruid)
        {
             ApiResponse<Rezept> localVarResponse = await GetRezeptUIdAsyncWithHttpInfo(ruid);
             return localVarResponse.Data;
        ...
        /// <param name="ruid">Die Rezept UID.</param>
        /// <returns>Task of ApiResponse (Rezept)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Rezept>> GetRezeptUIdAsyncWithHttpInfo (string ruid)
        {
            // verify the required parameter 'ruid' is set
            if (ruid == null)
                throw new ApiException(400, "Missing required parameter 'ruid' when calling RezeptUIDApi->GetRezeptUId");
        ...
        /// <param name="ruid">Die Rezept UID.</param>
        /// <returns>Task of RezeptStatus</returns>
        public async System.Threading.Tasks.Task<RezeptStatus> GetRezeptUIdStatusAsync (string ruid)
        {
             ApiResponse<RezeptStatus> localVarResponse = await GetRezeptUIdStatusAsyncWithHttpInfo(ruid);
             return localVarResponse.Data;
        ...
        /// <param name="ruid">Die Rezept UID.</param>
        /// <returns>Task of ApiResponse (RezeptStatus)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<RezeptStatus>> GetRezeptUIdStatusAsyncWithHttpInfo (string ruid)
        {
            // verify the required parameter 'ruid' is set
            if (ruid == null)
                throw new ApiException(400, "Missing required parameter 'ruid' when calling RezeptUIDApi->GetRezeptUIdStatus");
        ...
        /// <summary>
        /// Statusänderung eines Rezeptes patchRezeptUIdStatus
        /// </summary>
        /// <exception cref="IO.Swagger.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="ruid">Die Rezept UID.</param>
        /// <param name="status">Status value</param>
        ...
        /// <param name="status">Status value</param>
        /// <returns>Task of RezeptStatus</returns>
        public async System.Threading.Tasks.Task<RezeptStatus> PatchRezeptUIdStatusAsync (string ruid, string status)
        {
             ApiResponse<RezeptStatus> localVarResponse = await PatchRezeptUIdStatusAsyncWithHttpInfo(ruid, status);
             return localVarResponse.Data;
        ...
        /// <param name="status">Status value</param>
        /// <returns>Task of ApiResponse (RezeptStatus)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<RezeptStatus>> PatchRezeptUIdStatusAsyncWithHttpInfo (string ruid, string status)
        {
            // verify the required parameter 'ruid' is set
            if (ruid == null)
                throw new ApiException(400, "Missing required parameter 'ruid' when calling RezeptUIDApi->PatchRezeptUIdStatus");

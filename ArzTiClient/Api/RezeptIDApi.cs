...
namespace IO.Swagger.Api
{
        ...
        public interface IRezeptIDApi : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<ApiResponse<Rezept>> DeleteRezeptIdAsyncWithHttpInfo (string apoik, RezeptTyp reztyp, string rezid);
        /// <summary>
        /// liefert ein Rezept
        /// </summary>
        /// <remarks>
        ...
        /// <param name="rezid">Die RezeptID.</param>
        /// <returns>Task of ApiResponse (Rezept)</returns>
        System.Threading.Tasks.Task<ApiResponse<Rezept>> GetRezeptIdAsyncWithHttpInfo (string apoik, RezeptTyp reztyp, string rezid);
        /// <summary>
        /// Statusabfrage eines Rezeptes
        /// </summary>
        /// <remarks>
        ...
        /// <param name="rezid">Die Rezept-ID.</param>
        /// <returns>Task of ApiResponse (Rezept)</returns>
        System.Threading.Tasks.Task<ApiResponse<Rezept>> GetRezeptIdStatusAsyncWithHttpInfo (string apoik, RezeptTyp reztyp, string rezid);
        /// <summary>
        /// Statusänderung eines Rezeptes
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<ApiResponse<RezeptStatus>> PatchRezeptIdStatusAsyncWithHttpInfo (string apoik, RezeptTyp reztyp, string rezid, string status);
        ...
        public partial class RezeptIDApi : IRezeptIDApi
    {
        ...
        /// <returns></returns>
        public RezeptIDApi(IO.Swagger.Client.Configuration configuration = null)
        {
        ...
        /// <summary>
        /// löscht ein Rezept deleteRezeptId
        /// </summary>
        /// <exception cref="IO.Swagger.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="apoik">Die Apotheken IK.</param>
        /// <param name="reztyp">.</param>
        ...
        /// <param name="rezid">Die RezeptID.</param>
        /// <returns>Task of Rezept</returns>
        public async System.Threading.Tasks.Task<Rezept> DeleteRezeptIdAsync (string apoik, RezeptTyp reztyp, string rezid)
        {
             ApiResponse<Rezept> localVarResponse = await DeleteRezeptIdAsyncWithHttpInfo(apoik, reztyp, rezid);
             return localVarResponse.Data;
        ...
        /// <param name="rezid">Die RezeptID.</param>
        /// <returns>Task of ApiResponse (Rezept)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Rezept>> DeleteRezeptIdAsyncWithHttpInfo (string apoik, RezeptTyp reztyp, string rezid)
        {
            // verify the required parameter 'apoik' is set
            if (apoik == null)
                throw new ApiException(400, "Missing required parameter 'apoik' when calling RezeptIDApi->DeleteRezeptId");
        ...
        /// <param name="rezid">Die RezeptID.</param>
        /// <returns>Task of Rezept</returns>
        public async System.Threading.Tasks.Task<Rezept> GetRezeptIdAsync (string apoik, RezeptTyp reztyp, string rezid)
        {
             ApiResponse<Rezept> localVarResponse = await GetRezeptIdAsyncWithHttpInfo(apoik, reztyp, rezid);
             return localVarResponse.Data;
        ...
        /// <param name="rezid">Die RezeptID.</param>
        /// <returns>Task of ApiResponse (Rezept)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Rezept>> GetRezeptIdAsyncWithHttpInfo (string apoik, RezeptTyp reztyp, string rezid)
        {
            // verify the required parameter 'apoik' is set
            if (apoik == null)
                throw new ApiException(400, "Missing required parameter 'apoik' when calling RezeptIDApi->GetRezeptId");
        ...
        /// <param name="rezid">Die Rezept-ID.</param>
        /// <returns>Task of Rezept</returns>
        public async System.Threading.Tasks.Task<Rezept> GetRezeptIdStatusAsync (string apoik, RezeptTyp reztyp, string rezid)
        {
             ApiResponse<Rezept> localVarResponse = await GetRezeptIdStatusAsyncWithHttpInfo(apoik, reztyp, rezid);
             return localVarResponse.Data;
        ...
        /// <param name="rezid">Die Rezept-ID.</param>
        /// <returns>Task of ApiResponse (Rezept)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Rezept>> GetRezeptIdStatusAsyncWithHttpInfo (string apoik, RezeptTyp reztyp, string rezid)
        {
            // verify the required parameter 'apoik' is set
            if (apoik == null)
                throw new ApiException(400, "Missing required parameter 'apoik' when calling RezeptIDApi->GetRezeptIdStatus");
        ...
        /// <summary>
        /// Statusänderung eines Rezeptes patchRezeptIdStatus
        /// </summary>
        /// <exception cref="IO.Swagger.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="apoik">Die Apotheken IK.</param>
        /// <param name="reztyp">.</param>
        ...
        /// <param name="status">Status value</param>
        /// <returns>Task of RezeptStatus</returns>
        public async System.Threading.Tasks.Task<RezeptStatus> PatchRezeptIdStatusAsync (string apoik, RezeptTyp reztyp, string rezid, string status)
        {
             ApiResponse<RezeptStatus> localVarResponse = await PatchRezeptIdStatusAsyncWithHttpInfo(apoik, reztyp, rezid, status);
             return localVarResponse.Data;
        ...
        /// <param name="status">Status value</param>
        /// <returns>Task of ApiResponse (RezeptStatus)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<RezeptStatus>> PatchRezeptIdStatusAsyncWithHttpInfo (string apoik, RezeptTyp reztyp, string rezid, string status)
        {
            // verify the required parameter 'apoik' is set
            if (apoik == null)
                throw new ApiException(400, "Missing required parameter 'apoik' when calling RezeptIDApi->PatchRezeptIdStatus");

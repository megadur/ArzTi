 ...
 *
 * Kommunikation des Webservers mit den jeweiligen Rechenzentren V.2021-06-02 
 *
...
namespace ArzTiServer.Api.Controllers
{
    ...
    public abstract class RezeptIDListApiController : ControllerBase
    {
        ...
        [SwaggerResponse(statusCode: 401, type: typeof(Error), description: "Unauthorized")]
        [SwaggerResponse(statusCode: 404, type: typeof(Error), description: "The specified resource was not found")]
        public abstract Task<IActionResult> GetRezeptIdStatusList([FromRoute(Name = "apoik")][Required] string apoik, [FromQuery(Name = "reztyp")] RezeptTyp? reztyp, [FromQuery(Name = "zeitraum")] string zeitraum, [FromQuery(Name = "abgeholt")] bool? abgeholt);

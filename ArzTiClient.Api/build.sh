...
${nuget_cmd} install src/ArzTiClient/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/ArzTiClient.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/ArzTiClient.dll \
-recurse:'src/ArzTiClient/*.cs' \
-doc:bin/ArzTiClient.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/ArzTiClient.dll was created successfully"
fi
